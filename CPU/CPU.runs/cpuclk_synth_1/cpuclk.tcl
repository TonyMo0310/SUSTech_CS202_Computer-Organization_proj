...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir F:/ComputerOrganization/SUSTech_CS202_Computer-Organization_proj/CPU/CPU.runs/cpuclk_synth_1 -new_name cpuclk -ip [get_ips cpuclk]]
